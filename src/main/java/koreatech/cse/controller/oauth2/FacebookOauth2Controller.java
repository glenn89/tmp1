...
public class FacebookOauth2Controller {
    private static String facebook_client_id = "1696056593957213";      //본인 것으로 추가하기
    private static String facebook_client_secret = "b52134f336c21b150fea4db06976e519";  //본인 것으로 추가하기
