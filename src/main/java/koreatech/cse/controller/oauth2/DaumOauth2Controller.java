...
public class DaumOauth2Controller {
    private static String daum_client_id = "7681072394632344208";      //본인 것으로 추가하기
    private static String daum_client_secret = "c4689d61add11a0c3271c7abf6fa02fa";  //본인 것으로 추가하기
    ...
    private static String daum_rest_api_key = "32ea45709650aeb0bb98be1039f89cf6";   //본인 것으로 추가하기
